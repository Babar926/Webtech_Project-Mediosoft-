...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2025 at 05:54 PM
...
(9, '../assets/image/medicines/wallpaperflare.com_wallpaper.jpg', 'jjk', 'anime', 1, 1, 400, 44, 1, '2025-01-18', '2026-05-18');
...
(8, 'new category', 'new category description.', 1);
...
INSERT INTO `medicine_requests` (`id`, `medicine_name`, `medicine_category`, `company_name`, `medicine_country`, `name`, `email`, `message`, `created_at`) VALUES
(1, 'calbo-D', 'Tablet', 'ACI', 'bangladeshi', 'Saiful', 'saiful@gmail.com', 'manage it.', '2025-01-18 09:46:33');
